  ...
  return (
    <div className='relative pt-40'>
      ...
      <div style={{ cursor: 'url(feather-pen.png), auto' }} className='flex flex-col items-center'>
        <div className='relative pointer-events-none flex flex-col w-full items-center gap-5'>
          <div className='flex'>
          ...
          <p className='pointer-events-auto relative text-xl text-gray-700'>Want to Contact me? Say <a className='underline' href="mailto:viktor.trojann@gmail.com">viktor.trojann@gmail.com</a></p>
        </div>
